...
static const std::string INVENTORY_REQ_SCHEMA_NAME { "http://puppetlabs.com/inventoryschema" };
static const std::string INVENTORY_RESP_SCHEMA_NAME { "http://puppetlabs.com/inventoryresponseschema" };
...
static CthunClient::Schema getInventoryResponseMessageSchema() {
    CthunClient::Schema schema { INVENTORY_RESP_SCHEMA_NAME,
                                 CthunClient::ContentType::Json };
    schema.addConstraint("endpoints", T_C::Array, true); // mandatory
    return schema;
}
