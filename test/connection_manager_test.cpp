#include "test.h"
#include "connection_manager_certificates.h"
...
class ConnectionManagerTest : public ::testing::Test {
  public:
    ...
    void writeCertificates() {
        try {
            Common::FileUtils::writeToFile(CA, CA_PATH);
            Common::FileUtils::writeToFile(CRT, CRT_PATH);
            Common::FileUtils::writeToFile(KEY, KEY_PATH);
        } catch (Common::FileUtils::file_error& e) {
  ...
  protected:
    ...
    virtual void TearDown() {
        try {
            Common::FileUtils::removeFile(CA_PATH);
            Common::FileUtils::removeFile(CRT_PATH);
            Common::FileUtils::removeFile(KEY_PATH);
        } catch (Common::FileUtils::file_error) {
...
static const Common::UUID TEST_UUID { Common::getUUID() };
